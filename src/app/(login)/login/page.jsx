      ...
      <div className="h-[74%] w-[70vw] rounded-[15px] bg-gray-900 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-50 flex">
        ...
        <div className="h-full w-full flex flex-col justify-around items-center">
          ...
          <form className="flex flex-col gap-3 w-1/2">
            ...
            <Link href='/home' className="text-xl px-6 py-3 mt-2 bg-gray-900 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-70 shadow-2xl rounded-full flex justify-center items-center">
              Continuar
            </Link>
          </form>
