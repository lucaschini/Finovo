      ...
      <div className="h-[74%] w-[70vw] rounded-[15px] bg-gray-900 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-50 flex">
        ...
        <div className="h-full w-full flex flex-col justify-around items-center">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link href='/home' className="px-3 py-2 bg-gray-900 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-70 shadow-2xl rounded-full flex justify-center items-center">
              Cadastre-se
            </Link>
          </form>
          <Link href="/" className="text-xs hover:text-violet-500">Já possuo uma conta</Link>
        </div>
      </div>
    </div>
  );
